...
async function obtenerIncidenciasReabiertas(idIncidencia) {
    ...
    try {
        const response = await fetch('http://'+serverIP+'/api/v1/incidencias/incidencias-reabiertas/' + idIncidencia, {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${token}`
            }
...
export async function obtenerParteTrabajo(idIncidencia) {
    ...
    const apiUrl = 'http://'+serverIP+'/api/v1/parte-trabajo/incidencia/${idIncidencia}'; // Ruta para obtener el detalle de parteTrabajo
...
export async function comprobarTiempoEmpleadoSinHoraFin(idOrden) {
    const response = await fetch('http://'+serverIP+'/api/v1/tiempo-empleado/parte-trabajo-no-terminado/${idOrden}', {
        method: 'GET',
        headers: {
...
export async function comprobarTrabajoNoTerminado(idIncidencia) {
    ...
    const response = await fetch('http://'+serverIP+'/api/v1/parte-trabajo/incidencia-no-terminada/${idIncidencia}', {
        method: 'GET',
        headers: {
...
export async function empezarTrabajo() {
    ...
    if (modoResolucionSeleccionado === 'sinModoResolucion') {
        ...
        const apiUrlEmpezarTrabajo = 'http://'+serverIP+'/api/v1/parte-trabajo'; // Ruta para empezar el trabajo
        const apiUrlRegistrarTiempo = 'http://'+serverIP+'/api/v1/tiempo-empleado'; // Ruta para registrar el tiempo empleado
...
async function cambiarEstadoEmpezarTb(objetoIncidencia, token) {
    ...
    var urlPut = 'http://'+serverIP+'/api/v1/incidencias/' + objetoIncidencia.idIncidencia;
...
export async function finTrabajo(objetoIncidencia) {
    ...
    try {
        ...
        if (typeof tiempoEmpleado === 'object' && tiempoEmpleado !== null) {
            ...
            const respuesta = await fetch('http://'+serverIP+'/api/v1/tiempo-empleado/${idTiempoEmpleado}', {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${obtenerToken()}`
            ...
            const respuestaIncidencia = await fetch('http://'+serverIP+'/api/v1/incidencias/${objetoIncidencia.idIncidencia}', {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${obtenerToken()}`
