    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(authRequest -> authRequest
                    .requestMatchers("/auth/**","api/v1/usuarios/codigo-contraseña/**","api/v1/usuarios/cambiar-contraseña/**","/**","/app_trabajador/**","/app_tecnico/**","/app_cliente/**","/html/**","/css/**","/js/**","/assets/**").permitAll()
